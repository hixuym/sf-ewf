...
public interface TemplateEngine {
  ...
  /**
   * For instance returns ".ftl.html" Or .ftl.json. <p> Or anything else. To display error messages
   * in a nice way... <p> But Gson for instance does not use a template to render stuff. Therefore
   * it will return null
   *
