...
public interface Context {
  ...
  /**
   * Finalizing the headers copies all stuff into the headers. It of course also handles Gizmo
   ...
   * After finalizing the headers you can access the responseStreams.
   *
   * This method does not set any Gizmo session of flash information. Eg. When serving static assets
