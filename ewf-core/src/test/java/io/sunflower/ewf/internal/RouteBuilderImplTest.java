...
//    }
    ...
    public void testThatGlobalFiltersInRouteReplaceGlobalFiltersInConfFilters() throws Exception {
        // DummyFilter is defined in conf.Filters, but .overrideGlobalFilters(DummyFilter2.class) should
        // override that.
        ...
        routeBuilder.GET().route("/").overrideGlobalFilters(DummyFilter2.class).with(() -> expectedResult);
        Route route = routeBuilder.buildRoute(injector);
    ...
    public void testWithGlobalFiltersClass() throws Exception {
        ...
        routeBuilder.GET().route("/").overrideGlobalFilters(DummyFilter.class).with(() -> expectedResult);
        Route route = routeBuilder.buildRoute(injector);
    ...
    public void testWithGlobalFiltersList() throws Exception {
        ...
        routeBuilder.GET().route("/").overrideGlobalFilters(Lists.newArrayList(DummyFilter.class))
                .with(() -> expectedResult);
        Route route = routeBuilder.buildRoute(injector);
