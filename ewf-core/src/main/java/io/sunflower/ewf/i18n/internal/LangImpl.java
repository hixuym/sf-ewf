...
package io.sunflower.ewf.i18n.internal;
...
public class LangImpl implements Lang {
    ...
    @Inject
    public LangImpl(Settings configuration) {
    ...
    String getDefaultLanguage(Settings configuration) {
