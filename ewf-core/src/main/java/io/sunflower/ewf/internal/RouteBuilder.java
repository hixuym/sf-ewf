...
public interface RouteBuilder extends WithControllerMethod<Void> {
     ...
     * @return
     */
    RouteBuilder ignoreGlobalFilters();
     ...
     * @return
     */
    RouteBuilder overrideGlobalFilters(Class<? extends Filter>... filters);
     ...
     * @return
     */
    RouteBuilder overrideGlobalFilters(List<Class<? extends Filter>> filters);
