...
public class ServletCookieHelper {
    ...
    public static Cookie convertEwfCookieToServletCookie(io.sunflower.ewf.Cookie cookie) {
    ...
    public static io.sunflower.ewf.Cookie convertServletCookieToEwfCookie(
                                                                 @NotNull Cookie cookie) {
        io.sunflower.ewf.Cookie.Builder ninjaCookieBuilder
            = io.sunflower.ewf.Cookie.builder(cookie.getName(), cookie.getValue());
