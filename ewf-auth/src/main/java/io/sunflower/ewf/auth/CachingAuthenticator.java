...
public class CachingAuthenticator<C, P extends Principal> implements Authenticator<C, P> {
  ...
  /**
   * Discards any cached principal for the collection of credentials satisfying the given
   * predicate.
   *
  ...
  /**
   * Exception thrown by {@link CacheLoader#load(Object)} when the authenticator returns {@link
   * Optional#empty()}. This is used to prevent caching of invalid credentials.
   */
